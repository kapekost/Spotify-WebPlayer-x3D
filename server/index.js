...
// Spotify will hit this callback to provide the code for the token
// we redirect the client to provide it in the url params
// the client will grab it from there to use in the Spotify web SDK
